...
pub struct Clause {
    ...
    /// 1-based position in the source file where this clause starts.
    pub source_pos: Option<crate::error::SourcePos>,
...
pub struct Addendum {
    ...
    pub title: String,
    pub anchor: Option<String>,
    /// 1-based position in the source file where this addendum's heading appears.
    pub source_pos: Option<crate::error::SourcePos>,
