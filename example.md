...
4. ## Okendo and Okendo Affiliate Personnel {#personnel}
...
6. ## Subprocessing {#subprocessing}
    ...
    1. Each Merchant Group Member authorises Okendo and each Okendo Affiliate to appoint (and permit each Subprocessor appointed in accordance with [this clause](#subprocessing) to appoint) Subprocessors in accordance with [this clause](#subprocessing) and any restrictions in the Principal Agreement.
    ...
    6. Okendo and each Okendo Affiliate shall ensure that each Subprocessor performs the obligations under [clause 3](#processing), [clause 4](#personnel), [clause 5](#security), [clause 7.1](#data-subject-measures), [clause 8.2](#breach-cooperation), [clause 9.1](#deletion-obligation) and [clause 10.1](#audit-obligation), as they apply to Processing of Merchant Personal Data carried out by that Subprocessor, as if it were party to this Addendum in place of Okendo.

7. ## Data Subject Rights {#data-subject-rights}

    1. Okendo and each Okendo Affiliate will make available technical and organisational measures for the fulfilment of the Merchant Group Members' obligations to respond to requests to exercise any Data Subject rights under the Applicable Laws. {#data-subject-measures}

    2. The Merchant authorises Okendo, each Okendo Affiliate, and each Contracted Processor to comply with any request from a Data Subject under any Data Protection Laws in respect of Merchant Personal Data.

    3. Okendo shall notify the Merchant if Okendo, any Okendo Affiliate, or any Contracted Processor receives a request from a Data Subject under any Data Protection Laws in respect of Merchant Personal Data.
...
8. ## Personal Data Breach {#data-breach}
    ...
    2. Okendo shall co-operate with Merchant and each Merchant Group Member and take such reasonable commercial steps as are directed by Merchant to assist in the investigation, mitigation and remediation of each such Personal Data Breach. {#breach-cooperation}

    3. Okendo shall maintain a register of all Personal Data Breaches and provide reasonable access to such records as is necessary for the Merchant to comply with any Applicable Laws.

9. ## Deletion or Return of Merchant Personal Data {#deletion}

    1. Subject to [clause 9.2](#deletion-merchant-option) and [clause 9.3](#deletion-retention), Okendo and each Okendo Affiliate shall: {#deletion-obligation}
    ...
    4. Okendo shall provide written certification to Merchant that it and each Okendo Affiliate has fully complied with [this clause](#deletion) within 90 days of the Cessation Date.

10. ## Audit Rights {#audit}

    1. Subject to [clause 10.2](#audit-conditions), Okendo and each Okendo Affiliate shall: {#audit-obligation}
...
13. ## US Privacy Law Specific Provisions {#us-provisions}
    ...
    1. Okendo is a "Service Provider" for the purpose of any relevant US Data Protection Laws. The Merchant discloses personal data to Okendo solely for:

        1. a valid business purpose; and

        2. for Okendo to perform the Services.

    2. To the extent that any US Data Protection Laws apply, Okendo will not, and will not authorise its Subprocessors to, re-identify any de-identified, anonymized, or pseudonymized data derived from personal data that is Processed by Okendo on behalf of the Merchant, unless instructed by Merchant in writing.
...
* Review Text
* Images / Videos ^2^
* Reviewer Social Media Profile Picture ^2^
* Additional review structured data ("Attributes") as configured by the Merchant ^1^
* Reviewer State / Zone of Residence ^1^
* Reviewer IP Address (for anti-fraud purposes only)
* Reviewer Device Fingerprint (for anti-fraud purposes only)

Question content including:

* Questioner Name
* Questioner Email Address
* Question Text
* Questioner Social Media Profile Picture ^2^
...
**The obligations and rights of the Merchant and Merchant Affiliates**

The obligations and rights of the Merchant and Merchant Affiliates are set out in the Principal Agreement and this Addendum.

**The period for which the personal data will be retained, or, if that is not possible, the criteria used to determine that period**

The personal data will be retained until termination or expiry of the Principal Agreement.
